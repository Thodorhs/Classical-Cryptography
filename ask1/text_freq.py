...
def count_latin_characters(input_file_path, output_csv_path):
    ...
    sorted_characters = sorted(character_counts.items(), key=lambda x: x[0])
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python3 text_freq.py <input_file_path> <output_csv_path>")
    else:
